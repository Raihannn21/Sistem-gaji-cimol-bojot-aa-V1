...
@section('content')
    <div class="mx-auto max-w-screen-2xl" x-data="{ 
        showModal: false,
        periods: [
            { id: 1, month: 'Juli', year: '2025', status: 'Open', total_employees: 120, total_amount: 'Rp 450.000.000', created_at: '2025-07-01' },
            { id: 2, month: 'Juni', year: '2025', status: 'Locked', total_employees: 118, total_amount: 'Rp 442.500.000', created_at: '2025-06-01' },
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h4 class="text-lg font-bold text-gray-800 dark:text-white">Rp 3.120.000.000</h4>
                        </div>
                    </div>
                </div>
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h4 class="text-lg font-bold text-gray-800 dark:text-white">117 Karyawan</h4>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                    ...
                                    <td class="px-5 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="/payroll/phl/periods/1" class="p-2 text-gray-500 hover:bg-gray-100 hover:text-brand-500 rounded-lg transition-colors dark:text-gray-400 dark:hover:bg-white/5" title="Detail">
