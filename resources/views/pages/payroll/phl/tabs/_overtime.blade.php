...
<div x-show="activeTab === 'overtime'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6" x-cloak>
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Rekapitulasi Lembur</h3>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50 dark:bg-white/[0.01]">
                        ...
                        <th class="px-6 py-4 text-[10px] font-black uppercase text-gray-400 text-center">Total Jam</th>
                        <th class="px-6 py-4 text-[10px] font-black uppercase text-gray-400 text-right">Nominal</th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-800 font-medium">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01]">
                        ...
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-800 dark:text-white">12 Jam</td>
                        <td class="px-6 py-4 text-right text-sm font-bold text-brand-600 tabular-nums">Rp 450.000</td>
                        <td class="px-6 py-4 text-center">
                            <button @click="showDetailModal = true; selectedEmployee = { name: 'Ahmad Fauzi', nrp: '1001' }" class="rounded-lg p-2 text-gray-400 hover:bg-gray-100 hover:text-brand-500 transition-colors"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg></button>
                        </td>
                    </tr>
                    @endfor
                </tbody>
