...
<div x-show="activeTab === 'overview'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6" x-cloak>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">153 <span class="text-xs font-medium text-gray-400">Orang</span></h4>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">94% <span class="text-xs font-medium text-green-500">Ready</span></h4>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h4 class="mt-1 text-xl font-bold text-brand-600 dark:text-brand-500">Rp 482.500.000</h4>
                </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
            ...
            <span class="inline-flex items-center gap-1.5 rounded-full bg-green-50 px-2 py-0.5 text-[10px] font-bold text-green-700 dark:bg-green-500/10 dark:text-green-500 uppercase tracking-wider">Sync Active</span>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                        <td class="px-6 py-4"><p class="text-sm font-bold text-gray-800 dark:text-white/90">Ahmad Fauzi</p><p class="text-xs text-gray-400">NRP. 100{{ $i }}</p></td>
