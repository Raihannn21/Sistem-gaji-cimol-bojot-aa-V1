...
<div x-show="activeTab === 'risk'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6" x-cloak>
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <x-ui.button variant="outline" @click="showImportRiskModal = true" className="flex items-center gap-2">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-base font-bold text-gray-800 dark:text-white/90">Daftar Tunjangan Risiko Lapangan</h3>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800 font-medium text-sm">
                    ...
                    <!-- Search Empty State -->
                    <tr x-show="riskList.length > 0 && filteredRisk().length === 0">
                        <td colspan="4" class="px-6 py-8 text-center text-gray-400 italic">
        ...
        <div x-show="riskList.length > 0" class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-800">
            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <select x-model.number="riskPerPage" @change="riskPage = 1" class="h-8 rounded-lg border border-gray-200 bg-white px-2 py-0.5 text-xs font-semibold outline-none focus:border-brand-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 transition-colors">
