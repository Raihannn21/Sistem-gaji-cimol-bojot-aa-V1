...
<div x-show="activeTab === 'risk'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6" x-cloak>
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Tunjangan Risiko Lapangan</h3>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50 dark:bg-white/[0.01]">
                        ...
                        <th class="px-6 py-4 text-[10px] font-black uppercase text-gray-400 text-center">Hari Risiko</th>
                        <th class="px-6 py-4 text-[10px] font-black uppercase text-gray-400 text-right">Total Tunjangan</th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-800 font-medium">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01]">
                        <td class="px-6 py-4 text-sm font-bold text-gray-800 dark:text-white">Budi Santoso</td>
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-800 dark:text-white">8 Hari</td>
                        <td class="px-6 py-4 text-right text-sm font-bold text-brand-600 tabular-nums">Rp 400.000</td>
