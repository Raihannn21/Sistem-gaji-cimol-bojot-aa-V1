...
<div x-show="activeTab === 'overview'" x-transition:enter="transition ease-out duration-300"
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
            <h3 class="text-base font-bold text-gray-800 dark:text-white/90">Rangkuman Penggajian PKWT (Pro-rata
                Kehadiran)</h3>
            ...
            @else
                <span
                    class="inline-flex items-center gap-1.5 rounded-full bg-yellow-50 px-2 py-0.5 text-[10px] font-bold text-yellow-700 dark:bg-yellow-500/10 dark:text-yellow-500 uppercase tracking-wider">Draft
                    Mode</span>
            @endif
        </div>
