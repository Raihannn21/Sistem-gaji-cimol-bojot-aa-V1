        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800 font-medium text-sm">
                    ...
                    <!-- Empty State -->
                    <tr x-show="filteredOvertime().length === 0">
                        <td colspan="4" class="px-6 py-8 text-center text-gray-400 italic" x-text="searchQuery ? 'Karyawan dengan nama atau ID tersebut tidak ditemukan di rekap lembur.' : 'Belum ada data lembur diinput untuk periode ini.'">
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-800">
            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <x-form.select-pagination model="overtimePerPage" page="overtimePage" />
                </div>
            </div>
