            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50 dark:bg-white/[0.01]">
                        ...
                        <th class="px-6 py-4 text-xs font-bold uppercase text-gray-500 tracking-wider text-center">Total Jam</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800 font-medium text-sm">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01]">
                        ...
                        <td class="px-6 py-4 text-center font-bold text-gray-800 dark:text-white/90">10 Jam</td>
                        <td class="px-6 py-4 text-right font-bold text-brand-600 tabular-nums">Rp 375.000</td>
                        <td class="px-6 py-4 text-center">
                            <button @click="showDetailModal = true; selectedEmployee = { name: 'Slamet Riyadi', nrp: '200{{ $i }}' }" class="rounded-lg p-2 text-gray-400 hover:bg-gray-100 hover:text-brand-500 transition-colors"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg></button>
                        </td>
                    </tr>
                    @endfor
                </tbody>
