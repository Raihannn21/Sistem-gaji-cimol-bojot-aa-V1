        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative group">
                        ...
                        <input type="text" placeholder="Cari karyawan..." class="h-11 w-full rounded-lg border border-gray-200 bg-white py-2.5 pl-12 pr-14 text-sm text-gray-800 outline-none focus:border-brand-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:focus:border-brand-500 sm:w-80 shadow-theme-xs">
                        <div class="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-400 dark:border-gray-800 dark:bg-white/[0.03]">
                            <span>⌘</span>
                            <span>K</span>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">1.250</h4>
                        </div>
                        <div
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">1.180</h4>
                        </div>
                        <div
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Resign</p>
                            <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">45</h4>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-red-50 text-red-600 dark:bg-red-500/10 dark:text-red-500">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400">SPHK</p>
                            <h4 class="mt-1 text-xl font-bold text-gray-800 dark:text-white/90">25</h4>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-yellow-50 text-yellow-600 dark:bg-yellow-500/10 dark:text-yellow-500">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
