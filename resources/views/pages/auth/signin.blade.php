...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            @if ($errors->any())
                                <div class="mb-5 rounded-xl bg-red-50 p-4 text-xs font-semibold text-red-600 dark:bg-red-500/10 dark:text-red-500 shadow-sm border border-red-100 dark:border-red-500/25">
            ...
            <div class="relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5"
                style="background-color: #300101">
