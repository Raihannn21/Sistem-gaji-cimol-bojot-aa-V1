            ...
            <td class="column-td left-column">
                ...
                <table class="item-table">
                    ...
                    <tr>
                        ...
                        <td class="item-dots">:</td>
                        <td class="item-val">Rp. {{ number_format($overtime_amount, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 50%; padding-right: 12px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="text-align: right; width: 100px;">Rp. {{ number_format($gaji_pokok + $risk_amount + $overtime_amount, 0, ',', '.') }}</td>
                    </tr>
                </table>
            </td>
            <td style="width: 50%; padding-left: 12px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="text-align: right; width: 100px;">Rp. 0</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="gaji-bersih-container">
        <table class="gaji-bersih-table">
            <tr>
                ...
                <td style="text-align: right; width: 50%;">Rp. {{ number_format($take_home_pay, 0, ',', '.') }}</td>
            </tr>
        </table>
    </div>
