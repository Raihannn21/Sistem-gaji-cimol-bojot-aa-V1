<div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] flex flex-col">
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1 min-w-0">
            ...
            <h4 class="mt-0.5 text-lg font-bold text-gray-800 dark:text-white/90 tabular-nums">245 <span class="text-xs font-medium text-gray-400">Orang</span></h4>
        </div>
    </div>
    ...
    <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 space-y-2">
        <div class="flex justify-between items-center text-[11px]">
            ...
            <span class="font-bold text-gray-800 dark:text-white tabular-nums">160 Orang</span>
        </div>
        <div class="flex justify-between items-center text-[11px]">
            <span class="font-medium text-gray-400 dark:text-gray-400">PHL</span>
            <span class="font-bold text-gray-800 dark:text-white tabular-nums">85 Orang</span>
        </div>
    </div>
</div>
