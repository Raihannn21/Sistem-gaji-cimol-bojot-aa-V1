    ...
    <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div class="w-full">
            ...
            <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                Statistik dan tren operasional penggajian karyawan
            </p>
        </div>

        <div class="flex items-start w-full gap-3 sm:justify-end">
            <div x-data="{ selected: 'salary' }"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const options = {
            series: [{
                name: 'Realisasi Gaji',
                data: [30, 41, 35, 51, 49, 62, 69, 91, 148, 110, 120, 138]
            }, {
                name: 'Estimasi Gaji',
                data: [25, 38, 40, 48, 55, 60, 72, 85, 130, 105, 115, 140]
            }],
            chart: {
                height: 300,
                type: 'area',
