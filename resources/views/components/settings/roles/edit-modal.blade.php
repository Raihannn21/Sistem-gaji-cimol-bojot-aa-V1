<template x-teleport="body">
    <div x-show="showEditModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
        ...
        <div @click.away="showEditModal = false" x-show="showEditModal" x-transition:enter="transition ease-out duration-300"
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui informasi profil dan hak akses pengguna di bawah ini.</p>
            ...
            <form class="mt-8 space-y-5 pb-10">
                ...
                <div class="space-y-2">
                    ...
                    <select x-model="selectedUser.role" class="w-full h-12 rounded-xl border border-gray-200 bg-white px-4 text-sm outline-none focus:border-brand-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white appearance-none">
                ...
                <div class="flex items-center gap-3 pt-4">
                    <x-ui.button variant="outline" className="flex-1" @click="showEditModal = false">Batal</x-ui.button>
                    <x-ui.button variant="primary" className="flex-1" type="submit">Update User</x-ui.button>
                </div>
            </form>
        </div>
    </div>
