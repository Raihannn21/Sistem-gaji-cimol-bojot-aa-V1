...
<template x-teleport="body">
    <div x-show="showAttendanceImportModal" 
        ...
        <div @click="!isUploading && (showAttendanceImportModal = false)" class="fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-sm"
        ...
        <div @click.stop class="relative w-full rounded-3xl bg-white dark:bg-gray-900 max-w-[700px] shadow-2xl border border-gray-100 dark:border-gray-800"
            ...
            <div class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                ...
                <!-- Header (Borderless & Spaced, matching employee import modal) -->
                <div class="px-2 pr-14 mb-6">
                    <h4 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Import Absensi PKWT</h4>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Unggah file Excel untuk periode ini.</p>
                </div>

                <!-- Form Content -->
                <form id="importAttendanceForm" action="{{ $period ? url('/payroll/pkwt/periods/' . $period->id . '/import-attendance') : '#' }}" method="POST" enctype="multipart/form-data" @submit="isUploading = true" class="flex flex-col">
                    @csrf
                    ...
                    <div class="custom-scrollbar max-h-[458px] overflow-y-auto p-2 space-y-6">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                        Pastikan file Anda memiliki urutan kolom berikut: <span class="font-semibold text-gray-700 dark:text-gray-300">Emp No, No ID, Nama, Tanggal, Scan Masuk, Scan Pulang</span>.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative group">
                            ...
                            <label for="attendanceFileInput" class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 dark:border-gray-700 dark:bg-dark-900 dark:hover:bg-gray-800 transition-all group-hover:border-brand-500">
