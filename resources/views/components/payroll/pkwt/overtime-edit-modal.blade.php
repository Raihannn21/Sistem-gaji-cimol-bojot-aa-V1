...
<template x-teleport="body">
    <div x-show="showEditOvertimeModal" 
        ...
        <div @click.away="showEditOvertimeModal = false" 
            ...
            <button @click="showEditOvertimeModal = false" class="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 sm:right-6 sm:top-6">
            ...
            <form :action="`/payroll/pkwt/periods/${$period ? $period->id : ''}/overtime/${selectedOvertimeId}`" method="POST" class="mt-8 space-y-5">
                @csrf
                @method('PUT')
