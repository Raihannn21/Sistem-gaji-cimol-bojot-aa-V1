...
<template x-teleport="body">
    <div x-show="showRiskDetailModal" 
        ...
        <div @click.away="showRiskDetailModal = false" 
             x-show="showRiskDetailModal"
             x-transition:enter="transition ease-out duration-300" 
            ...
            <div class="mt-6">
                <h4 class="text-sm font-bold text-gray-800 dark:text-white mb-4">Rincian Tunjangan Risiko (PKWT)</h4>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                    ...
                                    <td class="px-5 py-3.5">
                                        <div class="flex items-center justify-center gap-2">
                                            <button @click="showEditRiskModal = true; 
                                            ...
                                            <button @click="$dispatch('open-delete-modal', { 
                                                            url: '/payroll/pkwt/periods/{{ $period->id }}/risk/' + item.id,
                            ...
                            <tr x-show="selectedEmployeeRisks.length === 0">
                                <td colspan="{{ $period && $period->status !== 'Locked' ? 3 : 2 }}" class="px-5 py-8 text-center text-sm text-gray-400 italic">
            ...
            <div class="mt-8 flex justify-end pt-6 border-t border-gray-100 dark:border-gray-800">
                <x-ui.button variant="outline" @click="showRiskDetailModal = false" className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">Tutup</x-ui.button>
            </div>
        </div>
    </div>
</template>
