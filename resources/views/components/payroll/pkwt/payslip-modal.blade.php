        ...
        <div @click.away="showSlipModal = false" 
            ...
            <div id="payslip-content" class="dark:text-white/90">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-sm text-gray-500 font-bold uppercase tracking-widest mt-1">Periode Gaji PKWT Juli 2025</p>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3 pl-6 border-l-2 border-brand-100 dark:border-brand-500/20">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-bold text-gray-800 dark:text-white tabular-nums">Rp 375.000</span>
                            </div>
                            <div class="flex justify-between items-center">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3 pl-6 border-l-2 border-red-100 dark:border-red-500/20">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-bold text-red-500 tabular-nums">(Rp 90.000)</span>
                            </div>
                            <div class="flex justify-between items-center">
