...
<template x-teleport="body">
    <div x-show="showOvertimeDetailModal" 
        ...
        <div @click.away="showOvertimeDetailModal = false" 
             x-show="showOvertimeDetailModal"
             x-transition:enter="transition ease-out duration-300"
            ...
            <button @click="showOvertimeDetailModal = false" class="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 sm:right-6 sm:top-6 transition-colors duration-150">
            ...
            <div class="mt-8 flex justify-end pt-6 border-t border-gray-100 dark:border-gray-800">
                <x-ui.button variant="outline" @click="showOvertimeDetailModal = false" className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">Tutup</x-ui.button>
            </div>
        </div>
    </div>
</template>
