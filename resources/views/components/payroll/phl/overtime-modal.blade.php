...
<template x-teleport="body">
    <div x-show="showOvertimeModal" x-transition:enter="transition ease-out duration-300"
        ...
        <div @click.away="showOvertimeModal = false" x-show="showOvertimeModal"
            ...
            <button @click="showOvertimeModal = false"
            ...
            <div class="mb-8 pr-10">
                ...
                <p class="mt-1.5 text-sm text-gray-500 dark:text-gray-400">Tambahkan data lembur harian untuk perhitungan gaji.</p>
            </div>
            ...
            <form action="{{ route('payroll.phl.periods.store-overtime', $period->id) }}" method="POST" class="space-y-6 pb-32"
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <x-form.input name="rate" x-model="rate" label="Nominal Per Jam" prefix="Rp" placeholder="0" required @input="formatCurrency($event.target); calculate(); delete errors.rate;" />
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="note" placeholder="Masukkan detail aktivitas lembur..." rows="3"
                ...
                <div class="mt-8 flex justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-800">
                    <x-ui.button variant="outline" type="button" @click="showOvertimeModal = false" className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">Batal</x-ui.button>
