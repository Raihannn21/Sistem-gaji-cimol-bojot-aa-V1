<template x-teleport="body">
    <div x-show="showModal" 
        ...
        <div @click.away="showModal = false" 
            ...
            <h3 class="text-xl font-bold text-gray-800 dark:text-white/90">Input Lembur Karyawan</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan data lembur harian untuk perhitungan gaji.</p>
            ...
            <form class="mt-8 space-y-5">
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <x-form.date-picker label="Tanggal Lembur" name="overtime_date" placeholder="Pilih Tanggal" />
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Jumlah Jam</label>
                            <input type="number" placeholder="Contoh: 4" class="w-full rounded-lg border border-gray-200 bg-transparent px-4 py-2.5 text-sm outline-none focus:border-brand-500 dark:border-gray-800 dark:text-white">
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Keterangan / Aktivitas</label>
                        <textarea placeholder="Masukkan detail aktivitas lembur..." rows="3" class="w-full rounded-lg border border-gray-200 bg-transparent px-4 py-3 text-sm outline-none focus:border-brand-500 dark:border-gray-800 dark:text-white"></textarea>
                    </div>
                </div>
