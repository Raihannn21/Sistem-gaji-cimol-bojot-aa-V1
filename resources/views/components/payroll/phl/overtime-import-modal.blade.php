                ...
                <form id="importOvertimePhlForm" action="{{ $period ? url('/payroll/phl/periods/' . $period->id . '/import-overtime') : '#' }}" method="POST" enctype="multipart/form-data" @submit="isUploading = true" class="flex flex-col">
                    ...
                    <div class="custom-scrollbar max-h-[458px] overflow-y-auto p-2 space-y-6">
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-transparent flex justify-between items-center">
                            ...
                            <x-ui.button variant="outline" type="button" href="/templates/overtime_import_template_phl.xlsx" download className="flex items-center gap-2 text-xs font-semibold hover:bg-gray-100 dark:hover:bg-white/5">
                                Unduh Template
                            </x-ui.button>
                        </div>
