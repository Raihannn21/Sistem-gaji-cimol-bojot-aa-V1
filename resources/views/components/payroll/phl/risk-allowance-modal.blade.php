<template x-teleport="body">
    <div x-show="showRiskModal" x-transition:enter="transition ease-out duration-300"
        ...
        <div @click.away="showRiskModal = false" x-show="showRiskModal"
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Pilih karyawan dan tentukan nominal tunjangan
                risiko.</p>
            ...
            <form class="mt-8 space-y-5 pb-40">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="mb-2.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Nominal
                            (Rp)</label>
                        <input type="number"
                ...
                <div>
                    <label class="mb-2.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Keterangan /
                        Alasan</label>
                    <textarea rows="3"
                        class="w-full rounded-xl border border-gray-200 bg-transparent py-3 px-5 text-gray-800 outline-none focus:border-brand-500 dark:border-gray-800 dark:text-white dark:focus:border-brand-500"
                        placeholder="Contoh: Pekerjaan di area berisiko tinggi..."></textarea>
                </div>
