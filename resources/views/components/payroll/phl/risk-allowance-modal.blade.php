    ...
    <div x-show="showRiskModal" 
        ...
        <div @click.away="showRiskModal = false" 
            ...
            <div class="mb-8 pr-10">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white/90">Input Tunjangan Risiko (PHL)</h3>
                <p class="mt-1.5 text-sm text-gray-500 dark:text-gray-400">Pilih karyawan dan tentukan nominal tunjangan risiko bulanan.</p>
            </div>

            <!-- Form -->
            <form action="{{ route('payroll.phl.periods.store-risk', $period->id) }}" method="POST" class="space-y-6 pb-32"
