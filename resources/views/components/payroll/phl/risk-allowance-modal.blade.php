<template x-teleport="body">
    <div x-show="showModal" 
        ...
        <div @click.away="showModal = false" 
            ...
            <button @click="showModal = false" class="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 sm:right-6 sm:top-6">
            ...
            <form class="mt-8 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <x-form.date-picker label="Tanggal" name="risk_date" placeholder="Pilih Tanggal" />
                    <div>
                        <label class="mb-2.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Nominal (Rp)</label>
                        <input type="number" class="w-full rounded-xl border border-gray-200 bg-transparent py-3 px-5 text-gray-800 outline-none focus:border-brand-500 dark:border-gray-800 dark:text-white dark:focus:border-brand-500" placeholder="Contoh: 50000">
                    </div>
                </div>

                <div>
                    <label class="mb-2.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Keterangan / Alasan</label>
                    <textarea rows="3" class="w-full rounded-xl border border-gray-200 bg-transparent py-3 px-5 text-gray-800 outline-none focus:border-brand-500 dark:border-gray-800 dark:text-white dark:focus:border-brand-500" placeholder="Contoh: Pekerjaan di area berisiko tinggi..."></textarea>
                </div>
