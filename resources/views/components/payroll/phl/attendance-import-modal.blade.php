    ...
    <div x-show="showAttendanceImportModal" 
        ...
        <div @click.away="!isUploading && (showAttendanceImportModal = false)" 
            ...
            <div class="px-6 py-5 sm:px-8 border-b border-gray-100 dark:border-gray-800 flex-shrink-0 bg-white dark:bg-gray-900">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white/90">Import Absensi PHL</h3>
            ...
            <div class="p-6 sm:p-8 bg-white dark:bg-gray-900">
                <form id="importAttendanceForm" action="{{ route('payroll.phl.periods.import-attendance', $period->id) }}" method="POST" enctype="multipart/form-data" @submit="isUploading = true">
                    @csrf
                    <div class="space-y-6">
                        <!-- Guidance -->
