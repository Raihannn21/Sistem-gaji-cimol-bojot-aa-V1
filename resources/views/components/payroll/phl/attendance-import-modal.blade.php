        ...
        <div @click.stop class="relative w-full rounded-3xl bg-white dark:bg-gray-900 max-w-[700px] shadow-2xl border border-gray-100 dark:border-gray-800"
            ...
            <div class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                ...
                <div class="px-2 pr-14 mb-6">
                    <h4 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Import Absensi PHL</h4>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Unggah file Excel untuk periode ini.</p>
                </div>

                <!-- Form Content -->
                <form id="importAttendanceForm" action="{{ route('payroll.phl.periods.import-attendance', $period->id) }}" method="POST" enctype="multipart/form-data" @submit="isUploading = true" class="flex flex-col">
                    @csrf
