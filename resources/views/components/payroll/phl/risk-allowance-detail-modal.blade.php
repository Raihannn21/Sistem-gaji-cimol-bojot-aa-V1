                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-right font-bold text-brand-600 dark:text-brand-500">Rp 50.000</td>
                                <td class="px-4 py-3 text-xs text-gray-500 dark:text-gray-400 italic">Area Berisiko Tinggi - Site A...</td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        <button @click="showEditRiskModal = true; selectedRiskDate = '{{ now()->subDays($i)->format('d M Y') }}'; selectedRiskAmount = 50000; selectedRiskNote = 'Area Berisiko Tinggi - Site A'"
