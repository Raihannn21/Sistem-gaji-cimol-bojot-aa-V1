            ...
            <div class="text-center">
                ...
                <div class="mt-6 rounded-2xl bg-gray-50 p-4 text-left dark:bg-white/[0.03]">
                    ...
                    <div class="mt-2 flex items-start gap-2">
                        ...
                        <p class="text-[10px] text-yellow-600 leading-tight italic">Pastikan seluruh data lembur dan absensi telah divalidasi sebelum melanjutkan. Slip gaji akan otomatis dibuat setelah proses ini.</p>
                    </div>
                </div>
