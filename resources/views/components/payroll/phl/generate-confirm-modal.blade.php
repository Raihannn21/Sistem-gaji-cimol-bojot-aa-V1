        ...
        <div @click.stop class="relative w-full rounded-3xl bg-white dark:bg-gray-900 max-w-[700px] shadow-2xl border border-gray-100 dark:border-gray-800"
            ...
            <div class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                ...
                <div class="custom-scrollbar max-h-[458px] overflow-y-auto p-2 space-y-6">
                    <div class="rounded-2xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-800/50 dark:bg-white/[0.03]">
                        ...
                        <div class="mt-3 flex items-start gap-2.5">
                            ...
                            <p class="text-xs text-yellow-600 dark:text-yellow-500/80 leading-relaxed italic">Pastikan seluruh data lembur dan absensi telah divalidasi sebelum melanjutkan. Slip gaji akan otomatis dibuat setelah proses ini.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 px-2 mt-6 border-t border-gray-100 dark:border-gray-800 pt-5">
                    ...
                    <button type="button" @click="processing = true; document.getElementById('generate-payroll-form').submit();" :disabled="processing" class="flex justify-center rounded-lg bg-brand-500 px-6 py-2.5 text-sm font-medium text-white hover:bg-brand-600 shadow-lg shadow-brand-500/10 transition-all duration-150">
