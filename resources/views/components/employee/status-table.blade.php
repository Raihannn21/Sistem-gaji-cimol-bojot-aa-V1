<div x-data="{
    statusChanges: [
        { id: 1, name: 'Budi Santoso', nrp: '123458', role: 'Operator', type: 'Resign', date: '2026-04-15', reason: 'Pindah Domisili', team: 'T03', location: 'Site B' },
        { id: 2, name: 'Agus Salim', nrp: '123460', role: 'Staff Logistik', type: 'SPHK', date: '2026-04-20', reason: 'Habis Kontrak', team: 'T01', location: 'HO' },
        { id: 3, name: 'Dewi Lestari', nrp: '123465', role: 'HR Admin', type: 'Resign', date: '2026-05-01', reason: 'Kesehatan', team: 'T02', location: 'Site A' },
    ],
    getStatusClass(type) {
        return type === 'Resign' 
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.01]">
                            <td class="px-5 py-4">
                                <div>
                                    ...
                                    <span class="block text-gray-500 text-theme-xs dark:text-gray-400" x-text="item.nrp"></span>
                                </div>
                            </td>
                            <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <button class="p-2 text-gray-500 hover:bg-gray-100 hover:text-brand-500 rounded-lg transition-colors dark:text-gray-400 dark:hover:bg-white/5">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    </button>
                                    <button class="p-2 text-gray-500 hover:bg-gray-100 hover:text-red-500 rounded-lg transition-colors dark:text-gray-400 dark:hover:bg-white/5">
