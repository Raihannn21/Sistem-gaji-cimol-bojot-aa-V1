...
class PhlRiskImport implements ToModel, WithHeadingRow
{
    protected $periodId;
    ...
    public function model(array $row)
    {
        ...
        if (!$employee) {
            Log::warning("Employee with ID {$noId} not found or not PHL during risk allowance import.");
            $this->skippedCount++;
        ...
        try {
            ...
            $existing = PhlRiskAllowance::where('phl_payroll_period_id', $this->periodId)
            ...
            Log::error("Error importing PHL risk allowance row: " . $e->getMessage());
            $this->skippedCount++;
            return null;
        }
    }
    ...
    private function transformDate($value)
    {
        ...
        try {
            ...
            Log::error("Date parsing error in PHL risk allowance import for value '{$value}': " . $e->getMessage());
            return null;
        }
    }
